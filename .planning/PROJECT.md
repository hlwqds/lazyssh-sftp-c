...
v1.2 in progress — 文件管理操作（删除/重命名/新建/复制/移动）。
...
- 文件/目录删除（双面板，d 键，确认对话框）— v1.2
- 文件/目录重命名（双面板，R 键，内联编辑）— v1.2
- 新建目录（双面板，m 键，弹出输入框）— v1.2
...
v1.0 完成文件传输核心功能（3 phases）。v1.1 添加最近远程目录快速跳转功能（2 phases）。v1.2 添加文件管理操作（删除/重命名/新建/复制/移动）。
