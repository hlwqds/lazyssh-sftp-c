...
Phase 12 complete — 双远端文件浏览器组件（DualRemoteFileBrowser），两个独立 RemotePane 实例，并行 SFTP 连接，Tab 切换焦点，d/R/m 文件操作。
...
- v1.4 (in progress): Dup 修复 + 双远端文件互传 (Phase 10-12 complete — Dup fix, T key marking, dual remote browser)
...
---
*Last updated: 2026-04-16 — Phase 12 complete*
