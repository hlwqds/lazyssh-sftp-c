...
v1.2 complete 2026-04-15 — 全部文件管理操作已实现（删除/重命名/新建目录/复制/移动/冲突对话框）。
...
v1.0 完成文件传输核心功能（3 phases）。v1.1 添加最近远程目录快速跳转功能（2 phases）。v1.2 完成全部文件管理操作（3 phases）：删除/重命名/新建目录（Phase 6）、复制/剪贴板（Phase 7）、移动/冲突对话框（Phase 8）。
...
---
*Last updated: 2026-04-15 — v1.2 complete (Phase 8)*
